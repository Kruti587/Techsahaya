...
content = content.replace(
  ...
  /placeholder="Search schemes, benefits, or ask a question\.\.\."/g,
  'placeholder={tLocal("Search schemes, benefits, or ask a question...")}'
);
...
if (!content.includes('const tLocal = ')) {
  ...
  console.log("Localized AppShell (fixed injection)");
}
